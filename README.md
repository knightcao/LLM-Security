...
| 模型名称   | 模型版本  |  备注  | 下载链接  |
| :----      | :----:   | :----  |  :----   |
| 见微大模型安全防护围栏 商用版-Large  | 7 B   |  作为商用产品内核  | |
| 见微大模型安全防护围栏 商用版-Base   | 1 B   |  作为商用产品内核  | |
| 见微大模型安全防护围栏 商用版-Small  | 86 M  |  作为商用产品内核  | |
| 见微大模型安全防护围栏 开源版-Base   | 1 B   |  开源 | 后续提供 |
| &#x2705; 见微大模型安全防护围栏 开源版-Small-dev  | 86M |  开源 | https://huggingface.co/Huit/Changway_LLM_Guardv0.1 |
| &#x2705; 见微大模型安全防护围栏 开源版-Small-ascend 910B  | 86M |  开源 | https://huggingface.co/Huit/Changway_LLM_Guardv0.1 |
